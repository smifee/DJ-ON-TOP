...
module.exports = { 
    ...
    run: async (client, message) => {
        const msg = await message.channel.send("<a:LIT_pubg_loading:871120310894755900>reseting all filters.");
  ...
  if (channel.id !== player.voiceChannel) {
	...
	player.setEQ(Array(13).fill(0).map((n, i) => ({
        ...
        const nightcored = new MessageEmbed()
            .setTitle("<a:LIT_pubg_loading:871120310894755900> Reseted all filters ")
            .setColor('#000001');
