...
if (!args[0]) {
	player.setEQ([{
        ...
        const msg = await message.channel.send(`<a:LIT_pubg_loading:871120310894755900>Turning on **pop**.`);
		...
		const msg = await message.channel.send(`<a:LIT_pubg_loading:871120310894755900>Turning off **pop**.`);
			const embed = new MessageEmbed()
