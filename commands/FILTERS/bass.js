...
const player = message.client.manager.players.get(message.guild.id)
    	...
    	if (args[0].toLowerCase() == 'reset' || args[0].toLowerCase() == 'off') {		player.clearEffects()

		const msg = await message.channel.send(`<a:LIT_pubg_loading:871120310894755900>Turning off **bass**.`);
 ...
 const m1 = await message.channel.send("<a:LIT_pubg_loading:871120310894755900>Turning on **bass**.");
	...
	player.setBassboost(!player.bassboost)
	 ...
	 const bass = new MessageEmbed()
            ...
            .setTitle("<a:LIT_pubg_loading:871120310894755900> Turned on: bass",)
