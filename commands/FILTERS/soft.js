...
if (!args[0]) {
			...
			const msg = await message.channel.send(`<a:LIT_pubg_loading:871120310894755900>Turning on **soft**.`);
	...
	player.setEQ(Array(13).fill(0).map((n, i) => ({
        ...
        const msg = await message.channel.send(`<a:LIT_pubg_loading:871120310894755900>Turning off **soft mode**.`);
			const embed = new MessageEmbed()
