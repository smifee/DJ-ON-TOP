...
let msg = message.channel.send(`<a:Search:894144930761568296> searching  for \`${search}\``).then(m => m.delete({ timeout: 5000 }));
  ...
  try {
    ...
    let embed = new MessageEmbed()
      ...
      .setDescription(`<a:Search:894144930761568296> i can't find result about \`${search}\``
       )
    return message.channel.send(embed)
  }
  ...
  switch (res.loadType) {
    case 'NO_MATCHES':
      ...
      let embed = new MessageEmbed()
        ...
        .setDescription(`<a:Search:894144930761568296> i can't find results about \`${search}\``)
      return message.channel.send(embed)
